import { Toggle as Root } from "@base-ui-components/react/toggle";
...
export const toggleVariants = cva(
	cn(
		...
		"transition-[color,box-shadow] aria-invalid:ring-destructive/20",
...
export function Toggle( { className, variant, size, ...props }: ComponentProps<typeof Root> &
