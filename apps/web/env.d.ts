/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./env.d.ts` (hash: 009d4f81d715d7123b4f704fbe2749b7)
// Runtime types generated with workerd@1.20260702.1 2025-08-21 nodejs_compat
...
declare class EventSource extends EventTarget {
	...
	get onerror(): any | null;	static readonly CONNECTING: number;

	/* [MDN Reference](https://developer.mozilla.org/docs/Web/API/EventSource/error_event) */
	set onerror( value: any | null );	static readonly OPEN: number;

	static from( stream: ReadableStream ): EventSource;	static readonly CLOSED: number;
