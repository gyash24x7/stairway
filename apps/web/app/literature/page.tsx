import { cn, fjallaOne, Separator } from "@base/ui";
...
export default function LiteratureHomePage() {
	return (
		<div className={ "flex gap-10 flex-col mt-2" }>
			<h2 className={ cn( "text-3xl", fjallaOne.className ) }>LITERATURE</h2>
			<p>
			...
			<p className={ "mb-5" }>The objective is to win more books than the other team.</p>
			<p className={ "mb-5" }>
			...
			<div className={ "pl-2 mb-3" }>
				<p className={ "mb-2" }>A specific card must be requested e.g. "I would like the 8 of Spades"</p>
				<p className={ "mb-2" }>The player must hold a card that is part of the requested book</p>
				<p className={ "mb-2" }>The player asked must hold at least one card</p>
				<p className={ "mb-2" }>The player may not ask for a card already held</p>
