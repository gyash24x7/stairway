...
describe( "Button Component", function () {
	...
	it( "should render button text correctly", function () {
		const { queryByTestId } = render( <Button buttonText = { "Button Text" } appearance = { "warning" }/> );
	...
	it( "should not render button text when in loading state but render spinner with disabled button", function () {
