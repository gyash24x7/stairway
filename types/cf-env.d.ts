/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/cf-env.d.ts` (hash: 8590c45792f053b31b5e652c28b5f74b)
// Runtime types generated with workerd@1.20250913.0 2025-09-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		CALLBREAK_DO: DurableObjectNamespace<import("../src/worker").CallbreakDO>;
		FISH_DO: DurableObjectNamespace<import("../src/worker").FishDO>;
		WS_DO: DurableObjectNamespace<import("../src/worker").WebsocketDO>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_NAME" | "WEBAUTHN_RP_ID" | "APP_URL" | "AUTH_SECRET_KEY">> {}
}
