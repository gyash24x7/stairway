/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/env.d.ts` (hash: b0f42dcf6ea0458502bd9613047e4b81)
// Runtime types generated with workerd@1.20260424.1 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../src/worker");
		durableNamespaces: "UserSession" | "WordleEngine" | "SyncedStateServer" | "TicTacToeEngine" | "SplendorEngine" | "FishEngine" | "CallbreakEngine" | "KingdominoEngine";
	}
	...
	interface Env {
		...
		SESSION: DurableObjectNamespace<import("../src/worker").UserSession>;
		WORDLE_ENGINE: DurableObjectNamespace<import("../src/worker").WordleEngine>;
		SYNCED_STATE_SERVER: DurableObjectNamespace<import("../src/worker").SyncedStateServer>;
		TIC_TAC_TOE_ENGINE: DurableObjectNamespace<import("../src/worker").TicTacToeEngine>;
		SPLENDOR_ENGINE: DurableObjectNamespace<import("../src/worker").SplendorEngine>;
		FISH_ENGINE: DurableObjectNamespace<import("../src/worker").FishEngine>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AUTH_SECRET_KEY">> {}
}
...
declare class FormData {
	...
	forEach<This = unknown>( callback: (
		this: This,
		value: File | string,
		key: string,
		parent: FormData
	) => void, thisArg?: This ): void;
...
type LoopbackForExport<T extends ( new ( ...args: any[] ) => Rpc.EntrypointBranded ) | ExportedHandler<any, any, any> | undefined = undefined> = T extends new ( ...args: any[] ) => Rpc.WorkerEntrypointBranded
	...
	: T extends new ( ...args: any[] ) => Rpc.DurableObjectBranded
		...
		: T extends ExportedHandler<any, any, any> ? LoopbackServiceStub<undefined> : undefined;
...
type AiSearchMultiChatCompletionsRequest =
	Omit<AiSearchChatCompletionsRequest, "ai_search_options">
	& {
	ai_search_options: AiSearchMultiSearchOptions;
};
...
declare namespace Rpc {
	...
	type Stubify<T> = T extends Stubable ? Stub<T> : T extends Map<infer K, infer V>
		...
		: T extends Set<infer V> ? Set<Stubify<V>> : T extends Array<infer V>
			? Array<Stubify<V>>
			: T extends ReadonlyArray<infer V> ? ReadonlyArray<Stubify<V>> : T extends BaseType
				? T
				: T extends {
	...
	type Unstubify<T> = T extends StubBase<infer V> ? V : T extends Map<infer K, infer V>
		...
		: T extends Set<infer V> ? Set<Unstubify<V>> : T extends Array<infer V>
			? Array<Unstubify<V>>
			: T extends ReadonlyArray<infer V> ? ReadonlyArray<Unstubify<V>> : T extends BaseType
				? T
				: T extends {
