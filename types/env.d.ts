/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/env.d.ts` (hash: 73dfc5d51aa863ff48ece8b7a9048d45)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORDLE_ENGINE: DurableObjectNamespace /* WordleEngine */;
		TIC_TAC_TOE_ENGINE: DurableObjectNamespace /* TicTacToeEngine */;
		SPLENDOR_ENGINE: DurableObjectNamespace /* SplendorEngine */;
		FISH_ENGINE: DurableObjectNamespace /* FishEngine */;
		CALLBREAK_ENGINE: DurableObjectNamespace /* CallbreakEngine */;
		KINGDOMINO_ENGINE: DurableObjectNamespace /* KingdominoEngine */;
	}
}
