/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./types/env.d.ts` (hash: 702913af981de1b91ea2c5b73a131236)
// Runtime types generated with workerd@1.20260430.1 2025-08-21 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		WORDLE_ENGINE: DurableObjectNamespace<import("../worker/index").WordleEngine>;
		TIC_TAC_TOE_ENGINE: DurableObjectNamespace<import("../worker/index").TicTacToeEngine>;
		SPLENDOR_ENGINE: DurableObjectNamespace<import("../worker/index").SplendorEngine>;
		FISH_ENGINE: DurableObjectNamespace<import("../worker/index").FishEngine>;
		CALLBREAK_ENGINE: DurableObjectNamespace<import("../worker/index").CallbreakEngine>;
		KINGDOMINO_ENGINE: DurableObjectNamespace<import("../worker/index").KingdominoEngine>;
	}
}
