...
import { getCardDisplayString, getCardFromId } from "@/core/cards/utils";
import type { Book } from "@/core/fish/schema";
import { getBooksInHand, getCardsOfBook, getMissingCards } from "@/core/fish/utils";
...
export function AskCard() {
	...
	const { mutateAsync, isPending } = useMutation( orpc.fish.askCard.mutationOptions( {
