...
import { getCardDisplayString, getCardId } from "@/core/cards/utils";
import type { Book, PlayerId } from "@/core/fish/schema";
import { getBooksInHand, getCardsOfBook } from "@/core/fish/utils";
...
export function ClaimBook() {
	...
	const { mutateAsync, isPending } = useMutation( orpc.fish.claimBook.mutationOptions( {
