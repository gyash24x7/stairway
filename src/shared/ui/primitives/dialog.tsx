	...
	<Portal>
		...
		<Popup
			...
			className={ cn(
				...
				"translate-y-[-50%] gap-4 rounded-base border-2 border-outline bg-surface",
				"duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out",
				"data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
				"data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
				"data-[state=closed]:slide-out-to-left-1/2 p-6 shadow-sm md:shadow-md",
		...
		>
			...
			<Close
				className={ cn(
					"absolute right-4 top-4 rounded-xs opacity-100 ring-offset-background",
					"focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2",
					"disabled:pointer-events-none data-[state=open]:bg-background",
