...
import { suggestAsks, suggestCalls, suggestCardSets, suggestTransfer } from "@/server/literature/bot.service";
import type {
	AskCardInput,
	CallSetInput,
	CreateGameInput,
...
} from "@/server/literature/validators";
...
import { type Literature, LiteratureEvent } from "@/types/literature";
...
export async function createGame( { playerCount }: CreateGameInput, { authInfo }: Auth.Context ) {
