...
function serveExecutor(_, context) {
    return __awaiter(this, void 0, void 0, function () {
        var projectDir;
        return __generator(this, function (_a) {
            console.info("Executing \"vite preview\"...");
            projectDir = context.workspace.projects[context.projectName].root;
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    var devProcess = (0, child_process_1.exec)("vite preview --config ".concat(projectDir, "/vite.config.js --port 3000"), function (error, stdout, stderr) {
                        if (error) {
                            reject(error);
                        }
