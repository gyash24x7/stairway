/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ac8f10ac0f6ad650e47d8f63c974c089)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORDLE_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").WordleDurableObject>;
		LITERATURE_DURABLE_OBJECT: DurableObjectNamespace<import("./src/worker").LiteratureDurableObject>;
		DB: D1Database;
		ASSETS: Fetcher;
		LITERATURE_WORKFLOW: Workflow;
	}
}
...
declare namespace Rpc {
	...
	type Stubify<T> = T extends Stubable ? Stub<T> : T extends Map<infer K, infer V>
		...
		: T extends Set<infer V> ? Set<Stubify<V>> : T extends Array<infer V>
			? Array<Stubify<V>>
			: T extends ReadonlyArray<infer V> ? ReadonlyArray<Stubify<V>> : T extends BaseType ? T : T extends {
	...
	type Unstubify<T> = T extends StubBase<infer V> ? V : T extends Map<infer K, infer V>
		...
		: T extends Set<infer V> ? Set<Unstubify<V>> : T extends Array<infer V>
			? Array<Unstubify<V>>
			: T extends ReadonlyArray<infer V> ? ReadonlyArray<Unstubify<V>> : T extends BaseType ? T : T extends {
